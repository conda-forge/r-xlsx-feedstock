About r-xlsx-feedstock
======================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/r-xlsx-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=4288&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/r-xlsx-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `r-xlsx` can be installed with `conda`:
...
```
mamba install r-xlsx
```

It is possible to list all of the versions of `r-xlsx` available on your platform with `conda`:
...
```
mamba search r-xlsx --channel conda-forge
```
...
mamba repoquery search r-xlsx --channel conda-forge

# List packages depending on `r-xlsx`:
mamba repoquery whoneeds r-xlsx --channel conda-forge

# List dependencies of `r-xlsx`:
mamba repoquery depends r-xlsx --channel conda-forge
```
